...
CHECKS = {
    ...
    "Makro 3 rakamı": ("firmware/controller/main.c", "return HID_KEY_3;"),
    "Makro 4 rakamı": ("firmware/controller/main.c", "return HID_KEY_4;"),
    "Makro 5 rakamı": ("firmware/controller/main.c", "return HID_KEY_5;"),
    "GP4 3 eşlemesi": ("firmware/controller/main.c", "PIN_P1_TRIGGER 4u"),
    "GP5 4 eşlemesi": ("firmware/controller/main.c", "PIN_P1_BOMB    5u"),
    "GP6 5 eşlemesi": ("firmware/controller/main.c", "PIN_P2_START   6u"),
